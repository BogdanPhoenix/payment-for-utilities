...
public interface OblastService {
     ...
     */
    OblastResponse addValue(@NonNull OblastRequest request) throws EmptyRequestException, InvalidInputDataException, DuplicateException;
     ...
     */
    OblastResponse updateValue(@NonNull OblastUpdateRequest request) throws EmptyRequestException, InvalidInputDataException, DuplicateException, NotFindEntityInDataBaseException;
     ...
     */
    OblastResponse removeValue(Long id) throws NotFindEntityInDataBaseException;
